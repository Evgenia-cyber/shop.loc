                ...
                <form action="<?= ADMIN; ?>/currency/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value" placeholder="Укажите курс по отношению к базовой валюте" required data-error = 'Допускаются цифры и десятичная точка' pattern="^[0-9.]{1,}$" value="<?=h($currency->value)?>">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <label for="base">
                                <input type="checkbox" name="base" id="base" <?php if($currency->base) echo ' checked';?>>Базовая валюта</label>
                        </div>
