...
// Create the Transport
        ...
        $message_client = (new Swift_Message("Ваш заказ №{$order_id} с сайта " . App::$app->getProperty('shop_name')))
        ...
        $_SESSION['success'] = 'Спасибо за заказ. В ближайшее время с Вами свяжется наш менеджер для согласования заказа.';
    }
